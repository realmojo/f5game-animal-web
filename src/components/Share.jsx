...
export const Share = () => {
  ...
  const copy = () => {
    ...
    textarea.value = `https://animal.f5game.co.kr`;
  ...
  const createKakaoButton = () => {
    ...
    if (window.Kakao) {
      ...
      if (!kakao.isInitialized()) {
        ...
        kakao.init("d9aedb635913dd74c823a5761b497b37");
      }
      kakao.Link.createDefaultButton({
        ...
        content: {
          ...
          link: {
            mobileWebUrl: "https://animal.f5game.co.kr",
            webUrl: "https://animal.f5game.co.kr",
          },
        },
        buttons: [
          {
